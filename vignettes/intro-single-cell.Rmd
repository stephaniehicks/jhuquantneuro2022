...
6. Be able to list at least three quality control (QC) metrics for scRNA-seq data
7. Know the difference between fixed and adaptive thresholds for QC metrics
8. Be able to define a "library size" in terms of normalization
9. Describe some common probability distributions used to model scRNA-seq data
10. Describe imputation and what it does to scRNA-seq data
...
- https://docs.google.com/presentation/d/1cqWepQAdLeYctCLT-S9AWIxNHRjeW4PIGl89OWVkk1Y/edit?usp=sharing
